...
- [ ] The spec file changed in exactly four places — the Status line, the two new §7 risk rows, and the updated `rust-version`/`u64::is_multiple_of` row: `git diff docs/specs/` shows four hunks and nothing else.
